...
const Header = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      ...
      {showNav && (
        <nav className="flex flex-col md:hidden py-12 fixed bg-white top-0 left-0 w-full h-full z-50 space-y-4 items-center">
          <NavLink href="/">Home</NavLink>
          <NavLink href="/shop-cookies">Cookies</NavLink>
          <NavLink href="/merch">Merch</NavLink>
          <NavLink href="/wholesale">Wholesale</NavLink>
      ...
      <div className="flex md:hidden border-b border-vibrant w-full justify-between items-center pl-2">
        ...
        <div className="flex items-center">
          <Link href="/shop-cookies">
            <a className="text-mauve uppercase p-3 border-r border-l border-vibrant font-display text-xl">
              Order
            </a>
          </Link>
