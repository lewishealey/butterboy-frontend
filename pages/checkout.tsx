...
export default function Checkout({ settings, discounts }) {
  ...
  const inputClasses =
    "h-14 border-b border-vibrant px-8 bg-cream font-body text-vibrant outline-0";
  const buttonClasses =
    "w-full bg-mauve font-display px-5 py-4 uppercase text-vibrant border-b border-vibrant text-base md:text-xl hover:bg-vibrant hover:text-mauve inline-flex";
  ...
  const applyDiscount = () => {
    const hasDiscount = discounts.find(
    ...
    if (hasDiscount) {
      if (discount) {
        ...
        if (hasDiscount.type === "percent") {
          setFinalAmount(
            finalAmount - total.totalPrice * (hasDiscount.amount / 100)
          );
          setDiscount({
            ...hasDiscount,
            difference: (total.totalPrice * (hasDiscount.amount / 100)).toFixed(
              2
            ),
          });
        } else {
          ...
          setDiscount({
            ...hasDiscount,
            difference: hasDiscount.amount.toFixed(2),
          });
        }
      }
    }
  ...
  return (
    <Page title="Checkout" heading="Checkout" settings={settings}>
      <div className="flex min-h-screen border-b border-vibrant flex-col md:flex-row border-l border-r">
        <div className="w-full md:w-3/5 bg-cream flex justify-center md:border-r border-vibrant">
          <div className="flex flex-col w-full">
            {stage === 1 && (
              <>
                <fieldset className="flex flex-col">
                  ...
                  <input
                    className={inputClasses}
                    placeholder="Phone (required for deliveries)"
                    name="phone"
                  ...
                  <div className="flex space-x-2 items-center border-b border-vibrant py-4 px-8 cursor-pointer">
                    <input
                      type="checkbox"
                      className="h-4 w-4 rounded border border-vibrant cursor-pointer"
                      name="newsletter"
                      id="newsletter"
                    ...
                    />
                    <label
                      className="font-body text-vibrant cursor-pointer"
                      htmlFor="newsletter"
                    >
                      Email me with news, updates and offers
                    </label>
                  </div>
                </fieldset>
                <fieldset className="flex flex-col">
                ...
                {deliveryType == "local-delivery" && (
                  <fieldset className="flex flex-col border-b border-vibrant">
                    <SectionLabel>Shipping</SectionLabel>
                    <div className="border border-gray-300 bg-cream rounded w-full">
                      <button
                        className={`flex justify-between px-8 py-4 w-full items-start text-left hover:bg-gray-100 
                    ${
                      shipping &&
                      ...
                      >
                        <div className="flex flex-col">
                          <div className="flex space-x-3 items-center">
                            <span className="text-vibrant text-lg font-body">
                              Local delivery
                            </span>
                          </div>
                          <span className="text-md text-vibrant font-body">
                            {deliveryDay}
                          </span>
                        </div>
                        <div className="hover:underline text-lg text-vibrant pt-1 font-body">
                          $10.00
                        </div>
                      </button>
                    </div>
                ...
                <div className="flex flex-col">
                  ...
                  <Link href="/cart">
                    <button className="hover:bg-white px-5 py-4 uppercase font-display text-vibrant text-base md:text-xl hover:bg-gray-200 inline-flex border-b border-vibrant md:border-0">
                      Back to cart
                    </button>
                  </Link>
                </div>
            ...
            {stage > 1 && (
              <fieldset className="flex flex-col">
                ...
                <div className="w-full">
                  {input.email && (
                    <button
                      className="flex justify-between px-4 py-2 w-full h-14 items-center bg-cream border-b border-vibrant"
                      onClick={() => setStage(1)}
                    >
                      ...
                      <div className="hover:underline text-base text-vibrant font-body">
                        Change
                      </div>
                    </button>
                  )}
                  {input.shipping && (
                    <button
                      className="flex justify-between px-4 py-2 w-full border-b border-vibrant h-14 items-center"
                      onClick={() => setStage(1)}
                    >
                      <div className="flex space-x-8">
                      ...
                      <div className="hover:underline text-base font-body text-vibrant">
                        Change
                      </div>
                    </button>
                  )}
            ...
            {stage >= 2 && (
              <>
                {deliveryType == "collect" && pickupDate && pickupTime && (
                  <fieldset className="flex flex-col">
                    <SectionLabel>Collection</SectionLabel>
                    <div className="w-full">
                      {pickupDate && (
                        <Link href="/cart">
                          <button className="flex justify-between px-4 py-2 w-full h-14 items-center">
                            <div className="flex space-x-8">
                              <span className="text-vibrant font-body">
                                Date
                              </span>
                      ...
                      {pickupTime && (
                        <Link href="/cart">
                          <button className="flex justify-between px-4 py-2 w-full border-t bg-cream border-vibrant font-body h-14 items-center border-b">
                            <div className="flex space-x-8">
                              <span className="text-vibrant">Time</span>
                              <span className="text-vibrant">{pickupTime}</span>
                            </div>
                            <div className="hover:underline text-base text-vibrant">
                              Change
                            </div>
                          </button>
                        </Link>
                ...
                {deliveryType == "merch-delivery" && (
                  <fieldset className="flex flex-col">
                    <SectionLabel>
                      {!shipping ? "Select a s" : "S"}hipping method
                    </SectionLabel>
                    <div className="border border-gray-300 bg-cream rounded w-full">
                      <button
                        className={`flex justify-between px-4 py-2 w-full items-start text-left hover:bg-gray-100 
                    ${
                      shipping &&
                      shipping.type === "standard" &&
                      "border-2 border-blue-500"
                      ...
                      >
                        <div className="flex flex-col">
                          <div className="flex space-x-3 items-center">
                            <Dot
                              checked={shipping && shipping.type === "standard"}
                            />
                            <span className="text-vibrant text-lg font-body">
                              Standard
                            </span>
                      ...
                      >
                        <div className="flex flex-col">
                          <div className="flex space-x-3 items-center">
                            <Dot
                              checked={shipping && shipping.type === "express"}
                            />
                            <span className="text-vibrant text-lg font-body">
                              Express
                            </span>
                          </div>
                          <span className="text-sm text-gray-500 font-body text-lg font-body">
                            2-4 business days, via Auspost
                          </span>
                        </div>
                        <div className="hover:underline text-lg text-vibrant font-body">
                          $25.00
                        </div>
                      </button>
                    </div>
                ...
                {stage === 2 && (
                  <div>
                    ...
                    {deliveryType === "collect" && (
                      <button className={buttonClasses} onClick={handlePayment}>
                        Proceed to payment
                      </button>
                    )}
                  </div>
            ...
            {stage === 3 && (
              <>
                <fieldset className="flex flex-col">
                  ...
                  <div className="w-full">
                    <button
                      className={`flex justify-between px-4 py-2 w-full items-center hover:bg-gray-100 h-14 border-b border-vibrant`}
                      onClick={() => {
                        const newState = {
                          ...input,
                          billing: input.shipping,
                    ...
                    >
                      <div className="flex space-x-3 items-center">
                        <Dot checked={input.sameAsShipping} />
                        <span className="text-vibrant font-body text-base">
                          Same as shipping address
                        </span>
                      </div>
                    </button>
                    <button
                      className={`flex justify-between px-4 py-2 w-full items-center hover:bg-gray-100 border-b border-vibrant h-14`}
                      onClick={() => {
                        const newState = {
                          ...input,
                          billing: blankCustomerInfo,
                ...
                <fieldset className="flex flex-col">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between px-4 py-2 w-full items-center">
                      <div className="flex flex-col">
                        <span className="text-vibrant font-body py-2">
                          All transactions are secure and encrypted.
                        </span>
                      </div>
                      <div className="hover:underline text-sm text-vibrant flex items-center">
                      ...
                      {paymentIntent && paymentIntent.client_secret ? (
                        ...
                        >
                          <ElementsForm
                            ...
                            onPaymentResolve={handleCheckout}
                            data={input}
                          />
                        </Elements>
                      ) : (
          ...
          <div className="top-0 sticky">
            {products &&
              products.map((product, i) => {
                return (
                  <div
                    className="flex w-full border-b border-vibrant px-6 h-20 pr-12"
                    key={`product_${i}`}
                  >
                    <div className="w-full flex space-x-2 items-center justify-between">
                      <div className="flex items-center space-x-6">
                        ...
                        <h3 className="text-base md:text-xl text-vibrant uppercase font-display">
                          {product.title}
                        </h3>
                      </div>
                      <span className="font-body text-xl text-vibrant">
                        ${product.price}
                      </span>
                    </div>
                  </div>
            ...
            {stage < 3 && (
              <div className="flex">
                ...
                />
                <button
                  className="bg-cream border-l border-vibrant px-4 inline-flex h-14 border-b items-center uppercase font-display text-vibrant h-full"
            ...
            <div className="flex flex-col justify-between py-4 md:py-6 border-b border-vibrant space-y-2 px-8">
              <div className="flex w-full justify-between">
                ...
                <div className="font-body text-xl font-body text-vibrant">
                  ${total.totalPrice.toFixed(2)}
                </div>
              </div>
              {discount && (
                <div className="flex w-full justify-between">
                  <div className="font-body text-xl text-vibrant">
                    Discount ({discount.title}){" "}
                    {stage < 3 ? (
                      <button onClick={clearDiscount} className="underline">
                        Clear
                      </button>
                    ) : (
                      <button onClick={() => setStage(2)} className="underline">
                        Change
                      </button>
                    )}
                  </div>
            ...
            <div className="flex flex-col justify-between space-y-2 px-8 py-4 md:py-6">
              <div className="flex w-full justify-between">
                ...
                <div className="font-body text-2xl space-x-2 items-center flex">
                  ...
                  <span className="text-2xl md:text-3xl text-vibrant">
